        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              {/* Client Info Display */}
              {clientInfo && (
                <div className="mt-2 p-3 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-700 rounded-xl">
                  <div className="flex items-center gap-2">
                    <CheckCircle className="text-emerald-500" size={20} />
                    <div>
                      <p className="font-semibold text-emerald-800 dark:text-emerald-300">{clientInfo.full_name}</p>
                      <p className="text-sm text-emerald-600 dark:text-emerald-400">ID: {clientInfo.client_id} | {clientInfo.phone}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {clientIdentifier.length >= 3 && !clientInfo && !lookingUpClient && (
                <div className="mt-2 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl">
